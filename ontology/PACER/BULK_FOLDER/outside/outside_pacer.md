...
**Murder for hire note:** Grayson (W.D. Tenn. 2:23-cr-20121) docs restricted (SCOTUS granted writ of certiorari June 24, 2026 (Case No. 25-851) and currently pending active review). Indictment, PSR position, and judgment were inaccessible under current restriction. The docket (253 entries) and DOJ press release were attached in the zipfile for ontology modeling and the Assault case (Perry & O'Dell, 2:22-cr-04065-BCW) carries conspiracy to murder federal officers for comparable CASE/UCO modeling purposes. A clean murder-for-hire case from an unrestricted docket can be substituted if needed.
